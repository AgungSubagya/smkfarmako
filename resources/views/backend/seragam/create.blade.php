    ...
    <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div>
                        <form action="/backend/seragam" enctype="multipart/form-data" method="post" class="row g-3">
                          @csrf
                          <div class="col-md-6">
                            <label for="nama" class="form-label">Nama Seragam</label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Masukan Nama Seragam" value="{{old('nama')}}">
                            @error('nama')
                          ...
                          <div class="col-12">
                            <label class="col-sm-2 col-form-label" for="image" class="form-label">Foto Seragam</label>
