...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
            <div>
                <form action="/backend/alamat/{{$a->id}}" method="post" class="row g-3">
                @method('put')
                @csrf
                <div class="col-md-12">
                    <label for="alamat" class="form-label">Alamat</label>
                        <textarea class="form-control @error('alamat') is-invalid @enderror " placeholder="...." name="alamat" id="editor" >{{ old('alamat',$a->alamat)}}</textarea>
                        @error('alamat')
                ...
                <div class="col-6">
                    ...
                    <input class="form-control mb-3  @error('telp') is-invalid @enderror" placeholder="+62" value="{{ old('alamat',$a->telp)}}" name="telp" type="text">
                    @error('telp')
                ...
                <div class="col-6">
                    ...
                    <input class="form-control mb-3  @error('email') is-invalid @enderror" name="email"  value="{{ old('email',$a->email)}}" placeholder="SMKFarmako@gmail.com" type="text" id="email">
                    @error('email')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
